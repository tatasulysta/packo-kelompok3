...
const PorridgeMenu = (props) => {
  return menu.porridgeMenus.map((porridge) => {
    return (
      <Col lg={4} className="mb-4 p-0" id="rice">
        <Card onClick={() => props.onClick(porridge)}>
          <Card.Body className="p-0">
            <Row>
              <Col lg={4}>
                <img
                  className="menu"
                  src={process.env.PUBLIC_URL + porridge.imgUrl}
                  alt="porridge-menu"
                />
              </Col>
